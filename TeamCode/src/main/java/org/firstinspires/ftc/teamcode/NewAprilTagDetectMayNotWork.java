...
@TeleOp
@Disabled
public class NewAprilTagDetectMayNotWork extends LinearOpMode
{
    ...
    @Override public void runOpMode()
    {
        ...
        while (opModeIsActive())
        {
            ...
            if (gamepad1.left_bumper && targetFound) {
                ...
                //drive
                strafe = Range.clip(rangeError * SPEED_GAIN, -MAX_AUTO_SPEED, MAX_AUTO_SPEED);
                turn  = Range.clip(headingError * TURN_GAIN, -MAX_AUTO_TURN, MAX_AUTO_TURN) ;
                //strafe
                drive = - Range.clip(-yawError * STRAFE_GAIN, -MAX_AUTO_STRAFE, MAX_AUTO_STRAFE);
